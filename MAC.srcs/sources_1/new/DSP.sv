...
module DSP #(
    ...
    input logic signed [mem_length-1:0]   read_data_port2,
    ...
    output logic signed [accum_length-1:0] prev_result
);
    ...
    assign product     = read_data_port1 * read_data_port2;
    assign next_acc    = accumulator + product;
    assign prev_result = finish ? next_acc : accumulator;
