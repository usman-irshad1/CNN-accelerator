...
module DSP_2 #(
    ...
    input logic signed [mem_length-1:0]   read_data_port3,
    ...
    output logic signed [accum_length-1:0] prev_result_1
);
    ...
    assign product     = read_data_port1 * read_data_port3;
    assign next_acc    = accumulator + product;
    assign prev_result_1 = finish ? next_acc : accumulator;
